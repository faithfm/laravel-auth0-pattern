...
return [
    ...
    'behavior' => [
        //NOTE: in our laravel-aut0-pattern we haven't yet updated our apps to use the new Guard Logic, so we enable 'legacyGuardUserMethod' until we have time to fix it.
        ...
        'legacyGuardUserMethod' => Configuration::stringToBoolOrNull(env('AUTH0_BEHAVIOR_LEGACY_GUARD_USER_METHOD'), true),
    ]
];
